<template>
  <fieldset class="agenda-item-form">
    ...
    <div class="agenda-item-form__row">
      ...
      <div> Starts at {{ agendaStartsAt }}</div>
    </div>

    <ui-form-group :label="titleType">
      <ui-input v-model="localAgendaItem.title" name="title" />
    </ui-form-group>
    <ui-form-group v-if="talkType" label="Докладчик">
      <ui-input v-model="localAgendaItem.speaker" name="speaker" />
    </ui-form-group>
    <ui-form-group v-if="talkType || otherType" label="Описание">
      <ui-input v-model="localAgendaItem.description" multiline name="description" />
    </ui-form-group>
    <ui-form-group v-if="talkType" label="Язык">
      <ui-dropdown 
  ...
  watch: {
    ...
    agendaStartsAt() {
      if (this.agendaDuration) {
        this.localAgendaItem.endsAt = 
          moment.utc(moment.duration(this.localAgendaItem.startsAt) + 
          moment.duration(this.agendaDuration)).format('HH:mm')
      }
    }, 
    agendaEndsAt() {
